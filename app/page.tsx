...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Navigation */}
      <nav className="fixed top-4 md:top-7 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] md:w-[944px] max-w-[944px]">
        <div className="bg-white/10 backdrop-blur-[12px] border border-white/10 rounded-[10px] shadow-[0px_4px_8px_0px_rgba(0,0,0,0.1)] h-[60px] md:h-[72px] px-4 md:px-6">
          <div className="flex items-center justify-between h-full">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-white flex items-center justify-center p-1">
              ...
              <span className="text-base md:text-xl font-light text-white">theo</span>
            </div>
      ...
      {/* Backed By Section */}
      <section className="py-12 md:py-16 bg-[#0c0e11] border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <p className="text-xs md:text-sm text-gray-500 uppercase tracking-wider mb-6 md:mb-8">BACKED BY:</p>
          <div className="relative overflow-hidden">
            <div className="flex items-center gap-8 md:gap-16 animate-scroll">
              <div className="text-base md:text-2xl font-light tracking-wider whitespace-nowrap">anthos</div>
              <div className="text-base md:text-2xl font-light tracking-wider whitespace-nowrap">HACK VC</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">MIRANA</div>
              <div className="text-base md:text-2xl font-light tracking-wider whitespace-nowrap">manifold</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">METALAYER VENTURES</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">SCB</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">Selini</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">Amber</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">MEXC</div>
              <div className="text-sm md:text-xl font-light whitespace-nowrap">Flowdesk</div>
              ...
              <div className="bg-gradient-to-br from-[#c8d8d8] to-[#88b8c8] rounded-3xl p-6 md:p-8 w-64 h-64 md:w-80 md:h-80 flex flex-col items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-2 md:gap-3 mb-4 md:mb-6">
                    <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#1a2332] flex items-center justify-center">
                      <span className="text-xl md:text-2xl text-white font-bold">₮</span>
                    </div>
                    <span className="text-2xl md:text-3xl font-light text-[#1a2332]">thBILL</span>
                  </div>
                  
                  {/* 描述 */}
                  <p className="text-[10px] md:text-xs text-[#1a2332]/60 uppercase tracking-wider mb-4 md:mb-6">
                    Short Duration US Treasuries
                  </p>
                  
                  {/* 收益率 */}
                  <div className="text-4xl md:text-6xl font-light text-[#1a2332] mb-2 md:mb-3">4.3%</div>
                  
                  {/* 底部信息 */}
                  <p className="text-[10px] md:text-xs text-[#1a2332]/60 uppercase leading-tight">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-16">
            <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-6 md:mb-8 rounded-full border-2 border-white/30 flex items-center justify-center">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="md:w-8 md:h-8">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <h2 className="text-3xl md:text-5xl font-light mb-4 md:mb-6 px-4">
              Built with <span className="text-[#918fff]">security</span>
              <span className="hidden md:inline"><br /></span>
              <span className="md:hidden"> </span>
              <span className="text-[#918fff]">& trust</span> in mind
            </h2>
            <p className="text-sm md:text-lg text-gray-400 mb-8 md:mb-12 max-w-2xl mx-auto px-4">
              We work with best-in-class partners to ensure the highest
              <span className="hidden md:inline"><br /></span>
              <span className="md:hidden"> </span>
          ...
          <div className="space-y-8 md:space-y-12">
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-3 md:mb-4">AUDITED BY</p>
              <div className="flex justify-center gap-6 md:gap-12 opacity-70">
                <div className="text-base md:text-xl">Zellic</div>
                <div className="text-base md:text-xl">code4rena</div>
              </div>
            </div>
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-3 md:mb-4">CUSTODY PARTNERS</p>
              <div className="flex justify-center gap-6 md:gap-12 opacity-70">
                <div className="text-base md:text-xl">FORDEFI</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Stay Up To Date */}
      <section className="py-6 md:py-10 bg-[#0c0e11]">
        <div className="max-w-[1024px] mx-auto px-4 md:px-10">
          <div className="bg-[#007f8e] rounded-[10px] px-5 md:px-8 py-4 md:py-5 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
            <h3 className="text-xl md:text-3xl lg:text-[32px] font-normal text-white leading-tight text-center md:text-left">Stay up to date</h3>
            <button className="px-6 md:px-8 py-2.5 md:py-3 bg-white text-black rounded-full font-normal text-sm md:text-[15px] hover:bg-gray-100 transition-all whitespace-nowrap backdrop-blur-[10px]">
              Follow Us On X
            </button>
          </div>
        </div>
        ...
        <div className="max-w-[1024px] mx-auto px-4 md:px-16">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-8">
            ...
            <div className="flex flex-col gap-4 md:gap-6 w-full md:w-auto">
              ...
              <button className="self-start px-6 md:px-8 py-2.5 md:py-3 bg-white text-black rounded-full font-normal text-sm md:text-[15px] hover:bg-gray-100 transition-all backdrop-blur-[10px]">
            ...
            <div className="flex flex-row gap-12 md:gap-16">
              ...
              <div className="flex flex-col gap-3 md:gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-sm md:text-base text-white opacity-50">Careers (Coming Soon)</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 md:gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <a href="#" className="text-sm md:text-base text-[#d6d6d6] hover:text-white transition-colors">Docs & FAQ</a>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="py-6 md:py-8 bg-[#0c0e11] border-t border-white/10">
        <div className="max-w-[1024px] mx-auto px-4 md:px-16">
          <p className="text-xs md:text-sm text-gray-500 font-mono text-center md:text-left">
